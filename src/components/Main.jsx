  ...
  return (
    <div className="container">
      ...
      <p>
        ...
        not expired and indicating that the client's record has not changed, so
        the product is still correct. The service also has a view button that
        shows a copy of the product that was issued. This allows a check that
        the product has not been altered since it was issued. <br />
        <br />
        <b>User Instructions:</b>
        <br />
        <br />
        1-
        <span id="firstInstr">Enter the document reference and press "Go"</span>
        <br />
      ...
      <ul className="frminpts cleaner">
        ...
        <li>
          <select
            ...
            <option value={105}>Drivers Experience/History Certificate</option>
            ...
            <option value={1019}>Special Permits / Site Inspection View</option>
            <option value={1025}>
            ...
            <option value={1013}>Special Permits / Special Needs Permit</option>
            <option value={1027}>Special Permits / Taxi Driver Permit</option>
            <option value={1044}>Special Permits / Tourist Guide Permit</option>
        ...
        <li className="interimRegistrationNoClass" style={{ display: "none" }}>
          <span className="inptcorns">
            <em>
              <input
                type="text"
